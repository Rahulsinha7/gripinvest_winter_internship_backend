...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-900"> {/* Added a light bg for contrast */}
    
      <div className="card w-96 bg-slate-800 shadow-xl">
        <div className="card-body">
           <h2 className="card-title justify-center text-3xl "><span className="text-slate-300">Welcome to!</span></h2>
          <h2 className="card-title justify-center text-3xl mb-6"><span className="text-blue-500">Grip Invest</span></h2> {/* Added mb-6 for spacing */}
